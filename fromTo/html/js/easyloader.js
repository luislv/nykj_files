...
var url=easyloader.base+”easyui-themes/"+easyloader.theme+"/"+_13["css"];
}
_c(url,function(){
_15="loaded";
...
var url=easyloader.base+"easyui-plugins/"+_13["js"];
}
_4(url,function(){
_14="loaded";
if(_14=="loaded"&&_15=="loaded"){
...
var url=easyloader.base+"easyui-locale/"+_2[easyloader.locale];
_9(url,function(){
_1c();
});
}else{
